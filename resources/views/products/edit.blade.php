...
<div class="text-h5 m-3" style="word-break: break-word">Editar produto</div>
                ...
                <div class="card-body">
                    <form method="POST" action="/products/{{$product->id}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" min="0" step="0.01" class="form-control @error('price') is-invalid @enderror" name="price" value="{{$product->price}}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="image_path" class="col-md-4 col-form-label text-md-right">Link (ou caminho) da imagem</label>

                            <div class="col-md-6">
                                <input id="image_path" type="text" class="form-control @error('image_path') is-invalid @enderror" name="image_path" value="{{$product->image_path}}" required autofocus>
