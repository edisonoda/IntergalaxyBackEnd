...
<div class="text-h5 m-3" style="word-break: break-word">Criar produto</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" min="0" step="0.01" value="0.00" class="form-control @error('price') is-invalid @enderror" name="price" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="image_path" type="text" class="form-control @error('image_path') is-invalid @enderror" name="image_path" required autofocus>
